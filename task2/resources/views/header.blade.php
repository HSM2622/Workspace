        ...
        @if (Route::has('login'))
          @auth
                <!-- <x-dropdown align="right" width="48">
                    <x-slot name="trigger"> -->
                        <div class="flex w-40 h-[4vh] justify-center items-center border-2 border-black mr-5 text-menu font-menu font-[550]">
                ...
                <!-- </x-slot> -->
                <!-- </x-dropdown> -->
                    <form method="POST" name="content" action="{{ route('logout') }}" class="flex w-40 h-[4vh] justify-center items-center border-2 border-black mr-5 text-menu font-menu font-[550]">
                        @csrf
